...
namespace ServiceRest_20190140010_FaisalFidiyatulloh
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-E4RVH2C;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=anonim07");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-E4RVH2C;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa; Password=anonim07");
